...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.actual_price'
        db.delete_column(u'crowdshop_task', 'actual_price')

        # Adding field 'Task.paid'
        db.add_column(u'crowdshop_task', 'paid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.actual_price'
        db.add_column(u'crowdshop_task', 'actual_price',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Task.paid'
        db.delete_column(u'crowdshop_task', 'paid')
    ...
    models = {
        ...
        u'crowdshop.task': {
            ...
            'paid': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'reward': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'tasks'", 'null': 'True', 'to': u"orm['crowdshop.State']"}),
