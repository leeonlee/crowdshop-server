...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crowdshop_task', (
            ...
            ('claimed_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='claimed_by', to=orm['auth.User'])),
    ...
    models = {
        ...
        u'crowdshop.task': {
            ...
            'claimed_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'claimed_by'", 'to': u"orm['auth.User']"}),
