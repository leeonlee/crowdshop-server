...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'crowdshop_task', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['crowdshop.State']))

    def backwards(self, orm):

        # Changing field 'Task.state'
        db.alter_column(u'crowdshop_task', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['crowdshop.State']))
    ...
    models = {
        ...
        u'crowdshop.task': {
            ...
            'actual_price': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
