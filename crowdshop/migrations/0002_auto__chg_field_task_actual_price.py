...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.actual_price'
        db.alter_column(u'crowdshop_task', 'actual_price', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Task.actual_price'
        db.alter_column(u'crowdshop_task', 'actual_price', self.gf('django.db.models.fields.IntegerField')())
